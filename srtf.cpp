...
void MainWindow::SRTF(QStackedWidget *pages)
{
    if (nb_processed != process_list.size())
    {
        ...
        if (process_queue.size() != 0)
        {
            ...
            sort_process(REMAINING_TIME, process_queue, processQueueProgressBars, processQueueRemainingTime, processQueueStateLabel);
