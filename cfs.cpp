...
void MainWindow::CFS(QStackedWidget *pages)
{
    if (nb_processed != process_list.size())
    {
        ...
        if (process_queue.size() != 0)
        {
            ...
            sort_process(PROCESSOR_TIME, process_queue, processQueueProgressBars, processQueueRemainingTime, processQueueStateLabel);
